...
class TestStringMethods(unittest.TestCase):
   ...
   #fazer
    ...
    def test_005_cria_questao(self):
        ...
        #self.assertTrue(self.verifica_questao(q1['erradas']))
        #self.assertTrue(self.verifica_questao(q1['corretas']))
    ...
    '''
    def test_005a_cria_questao(self):
        r = requests.post(url+'reseta')
